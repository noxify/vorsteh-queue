...
/**
 * Displays a colored badge indicating a job's current status.
 *
 * Uses Tailwind utility classes for styling so it works with any
 * component library (no custom Badge variants required).
 *
 * @example
 * ```tsx
