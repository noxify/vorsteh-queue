 ...
 *
 * Since ZenStack v3 uses `zen db push` for migrations and we may not
 * have the full ZenStack CLI available in CI, we create the table schema
 * directly via SQL for testing purposes.
 */
