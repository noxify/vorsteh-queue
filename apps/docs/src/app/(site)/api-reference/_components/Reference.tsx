import type { ReferenceComponents, ReferenceProps } from "renoun/components"
import type { JavaScriptFileExport } from "renoun/file-system"
import type { CSSObject } from "restyle"
import { Reference as DefaultReference, Markdown } from "renoun/components"

import * as Collapse from "./Collapse"

// eslint-disable-next-line @typescript-eslint/no-explicit-any
export function References({ fileExports }: { fileExports: JavaScriptFileExport<any>[] }) {
  return (
    <div
    //   css={{
    //     display: "flex",
...
export function Reference(props: ReferenceProps) {
  const components = {
    ...
    TableRowGroup: ({ hasSubRow, children }) => {
      return hasSubRow ? <Collapse.Provider>{children}</Collapse.Provider> : <>{children}</>
    },
