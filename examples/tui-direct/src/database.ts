...
// File-backed PGlite for multi-process access via socket server
...
/**
 * Start the PGlite socket server so the TUI dashboard process can connect
 * via queue.config.ts using node-postgres.
 */
